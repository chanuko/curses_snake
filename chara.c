...
NUM num[64]={
  ...
  {"111101111101111"},/*8*/
  {"111101111001001"},/*9*/
  {"000010111111101010111011100000"},/*pt*/  /*20*/
  {"100100100100111"},/*L*/
  {"010101111100011"},/*e*/
  {"000111101101101"},/*n*/
  {"000000101101010"},/*v*/
  {"000000000000100"},/*.*/  /*25*/
  {"111100000000000001111000000000000001000000000"}, /*title*/ /*26*/
...
void chara(int n,char ch){
  ...
  if(ch=='t'){
    ...
    case 'l' :
      ...
      p=11; q=7; x=SCR_X; y=FLD_Y-17;
      i=5; j=3; t=10;
      break;
    case 'p':
      draw_c(5,6,SUBS_Y+3, SCR_X-17,20);
      p=29; q=11; x=SCR_X; y=SUBS_Y+1;
      i=7; j=5; t=0;
      break;
    }
    m=n;
